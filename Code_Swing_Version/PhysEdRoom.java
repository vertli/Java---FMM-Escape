...
public class PhysEdRoom extends Classroom
{
    //Objects decleared
    static JLabel background;
    static PhysEdQuestion question;
    Box horizontalBox;
    JButton fill1, fill2;
     ...
     * post: PhysEdRoom  has been selected
     */
    public PhysEdRoom (Hallway hallway, Music bgm)
    {
    ...
    */
	...
	background = new JLabel (new ImageIcon ("classrooms/physedPic.jpg"));
	background.setLayout (new BoxLayout (background, BoxLayout.Y_AXIS));

	// create the SciQuestion object
	if (num == 0)
	    question = new PhysEdQuestion (hallway, bgm);
