...
public class EngQuestion extends Question
{
     ...
     * post: EngQuestion has been selected.
     */
    public EngQuestion (Hallway hallway, Music bgm)
    {
	// inheret parent class
	super (hallway, bgm);
	// Inititlize filler button
	this.textFile = new File ("questions/english.txt");
	this.getFile ();
	room = new EngRoom (hallway, bgm);
    } // constructor
